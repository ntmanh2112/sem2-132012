...
public class DesignationWeightage extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel = new JLabel();
			jLabel.setBounds(new Rectangle(89, 15, 270, 49));
			jLabel.setFont(new Font("Dialog", Font.BOLD, 24));
			jLabel.setText("Designation Weightage");
