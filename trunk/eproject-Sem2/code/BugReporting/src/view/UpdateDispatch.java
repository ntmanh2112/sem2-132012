...
public class UpdateDispatch extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel = new JLabel();
			jLabel.setBounds(new Rectangle(113, 16, 290, 63));
			jLabel.setFont(new Font("Dialog", Font.BOLD, 36));
			jLabel.setText("Update Dispatch");
	...
	private JButton getBtnUpdate() {
		if (btnUpdate == null) {
			...
			btnUpdate.setLocation(new Point(76, 418));
