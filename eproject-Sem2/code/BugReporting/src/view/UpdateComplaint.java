...
public class UpdateComplaint extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel = new JLabel();
			jLabel.setBounds(new Rectangle(108, 12, 326, 63));
			jLabel.setFont(new Font("Dialog", Font.BOLD, 36));
			jLabel.setText("Update Complaint");
	...
	private JButton getBtnUpdate() {
		if (btnUpdate == null) {
			...
			btnUpdate.setLocation(new Point(105, 407));
